...
// create some fake hard-coded data (fixtures)
const data = [
  {
    id: 1,
    name: 'Alice',
...
test('can display results from an API call', () => {
  // tell fake axios to intercept GET requests and return with our fake data
  ...
  // check if fake data was rendered to the DOM
